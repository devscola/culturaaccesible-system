  ...
  class Courier
    class << self
      ...
      def collect_polymer_files
        puts 'Support::Courier: starting to collect vendor files...'
        ...
        engine_class_js = File.open('public/vendor/classjs/class.min.js', 'w')
        ...
        engine_class_js.puts(class_js.readlines)

        engine_main.close
        engine_mini.close
        engine_micro.close
        engine_webcomponents.close
        engine_class_js.close

        puts 'Support::Courier: vendor files collected.'
      end
    end
  end
end
